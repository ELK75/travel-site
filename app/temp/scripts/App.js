...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.getStartedButton = (0, _jquery2.default)("#main-get-started-button")[0];
    ...
    _createClass(StickyHeader, [{
        ...
        value: function createPageSectionWaypoints() {
            ...
            this.pageSections.each(function () {
                ...
                new Waypoint({
                    element: that.getStartedButton,
                    handler: function handler(direction) {
                        if (direction == "up") {
                            that.headerLinks.each(function () {
                                (0, _jquery2.default)(this).removeClass("is-current-link");
                            });
                        }
                    }
                });
        ...
        key: 'resetPageSectionLinks',
        value: function resetPageSectionLinks() {}
    }]);
